...
export const diagnostic = {
	...
	filenotexist: localize('diagnostic.filenotexist', '\'{0}\' not exist'),
	...
	maybehavenotmember: localize('diagnostic.maybehavenotmember', 'Class \'{0}\' maybe have not member \'{1}\''),
	maybev1: localize('diagnostic.maybev1', 'This might be a v1 script, and the lexer stops parsing.'),
	...
	requirev1: localize('diagnostic.requirev1', 'This script requires AutoHotkey v1, and the lexer stops parsing.'),
	...
	typemaybenot: localize('diagnostic.typemaybenot', 'Type maybe not \'{0}\''),
