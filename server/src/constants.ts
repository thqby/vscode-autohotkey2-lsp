...
export const builtin_variable_h = ['a_ahkdir', 'a_dlldir', 'a_dllpath', 'a_globalstruct', 'a_isdll', 'a_mainthreadid', 'a_memorymodule', 'a_modulehandle', 'a_scriptstruct', 'a_threadid', 'a_zipcompressionlevel'];
